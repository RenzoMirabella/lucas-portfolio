          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 animate-fade-in">
              <div>
                ...
                Desde chico siempre fui el que estaba detrás de cámara, tratando de capturar momentos que no quería olvidar. Con el tiempo, esa curiosidad se transformó en una pasión que hoy es parte de mi día a día.
La fotografía y el cine me enseñaron a mirar distinto, a encontrar belleza en lo cotidiano y a contar historias sin necesidad de palabras. Cada proyecto es una excusa para explorar, aprender y conectar con otras personas.
Hoy sigo buscando esa chispa que me hizo enamorarme de la imagen, pero ahora con más herramientas, más experiencia, pero con las mismas ganas de siempre.
                </p>
              </div>

              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-semibold text-portfolio-text mb-3">Mi Enfoque</h3>
                  <p className="text-portfolio-text-muted leading-relaxed">
                  Hoy me dedico al filmmaking y a la fotografía, con la misma pasión por capturar momentos que digan algo. Disfruto tanto de filmar una historia como de encontrar una en una sola imagen.
                  Trabajo para crear piezas que no solo se vean bien, sino que digan algo. Porque cuando una historia está bien contada, no se olvida.
                  </p>
                </div>
              ...
              {[
                {
                  ...
                  imageUrl: "public/images/camara.png" // Cambia por tu imagen
                },
                {
                  title: "Drone",
                  description: "DJI Mavic 3 Pro.",
                  imageUrl: "public/images/drone.png" // Cambia por tu imagen
                },
                {
                  title: "Software de Edición",
                  description: "Davinci Resolve Studio.",
                  imageUrl: "public/images/davinci.png" // Cambia por tu imagen
                },
                {
                  title: "Lentes",
                  description: "Sony 16-35 GM 2.8 Tamron 28-75 2.8",
                  imageUrl: "public/images/lentes.png" // Cambia por tu imagen
                }
              ].map((equipment, index) => (
                <div 
                  key={index}
